function [outfile] = Giovanni_Sim1_V8_sameFeat_fun(inputArg, hiddenArg, silence)
...
%     MultiTask= sum(findMIS(logical(A_dual),[1:m]));
    ...
    outfile = ['logfiles/Giovanni_Simulation_V8_sameFeat_h' num2str(nHidden) '_' graphSpecsFolder '_' samplingFolder '_A' num2str(A_ID) '_' num2str(log_version) '.mat'];
