function [outfile] = Giovanni_Sim1_V8_subset_fun(inputArg, silence)
...
%         MultiTask= sum(findMIS(logical(A_dual),[1:m]));
    ...
    if(isa(inputArg, 'char'))
        outfile = ['logfiles/Giovanni_Simulation_V8_' graphSpecsFolder '_' samplingFolder '_A' num2str(A_ID) '_' num2str(log_version) '.mat'];
        save(outfile);
    end
end